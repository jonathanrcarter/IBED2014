...
public class BeaconLedSetting extends AbstractBeaconSetting {

	public BeaconLedSetting(String name, String commandString, String returnString, String defaultValue, boolean readOnly,boolean visible, String description) {
	...
	public void setValue(BeaconConnection beaconConnection)
	{
		...
		beaconConnection.transmitDataWithoutResponse(commandString);
	}
